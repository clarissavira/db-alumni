...
<div class="main-content" id="panel">
  ...
  <div class="container-fluid mt--6">
    <div class="row">
      <div class="col-xl-12">
        <a href="<?= site_url('laporan/cetak_alumni') ?>" target="_blank" class="btn btn-outline-white mb-3"><i class="fas fa-print"></i> Cetak Pdf</a>
        <!-- <a href="<?= site_url('laporan/excel') ?>" class="btn btn-secondary mb-3"><i class="fas fa-file"></i> Export Excel</a> -->
        <div class="card">
          <div class="card-body">
