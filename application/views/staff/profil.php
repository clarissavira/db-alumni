    ...
    <div class="container-fluid d-flex align-items-center">
      <div class="row">
        <div class="col-lg-12 col-md-12">
          ...
          <p class="text-white mt-0 mb-5">Sistem Informasi Pengarsipan Ijazah Dan Alumni Sekolah SMK AHMAD DAHLAN</p>
        ...
        <div class="card card-profile">
          ...
          <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
            <div class="d-flex justify-content-between">
              ...
              <a href="javascript:void(0);" class="btn btn-sm btn-default float-right">ALUMNI SMK</a>
            </div>
          </div>
          <div class="card-body pt-0">
            <div class="text-center">
              ...
              <div>
                <i class="ni education_hat mr-2"></i>SMK AHMAD DAHLAN
              </div>
            </div>
          </div>
        </div>
